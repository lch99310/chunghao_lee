...
thumbnail = '11_legends.png'
math = true
+++

*By Chung-Hao Lee*
*Data: MLB Stats API, 2023–2025 (≈1,000 pitcher-seasons, IP ≥ 50) · [GitHub Repo →](https://github.com/lch99310/Outs-Per-Effort) · [中文版 →](https://github.com/lch99310/Outs-Per-Effort/blob/main/README.cn.md)*
...
![Why the weight is 4](02_why_w4.png)
...
![Three scoreless innings, three different OPEs](01_example.png)
...
![OPE vs innings pitched](03_ope_vs_ip.png)
...
![Results by OPE tier](04_ope_vs_results.png)
...
![What OPE correlates with](05_correlations.png)
...
![Finesse vs power: both reach high OPE+](10_finesse.png)
...
![The OPE distribution and tiers](06_distribution.png)
...
![League-average OPE over time](07_league_trend.png)
...
![Team average OPE](08_team_ope.png)
...
![OPE agrees with the Cy Young voters](09_cy_young.png)
...
![Era-adjusted OPE across Hall-of-Fame careers](11_legends.png)
...
![2026 OPE leaderboard](12_ope_2026.png)
...
Everything here is reproducible from the [Outs-Per-Effort GitHub repo](https://github.com/lch99310/Outs-Per-Effort):

- **Data** — [`data/`](https://github.com/lch99310/Outs-Per-Effort/tree/main/data): raw pitching lines from the public MLB Stats API (`statsapi.mlb.com`) — regular season 2023–2025 plus 2026-to-date, Hall-of-Fame and finesse career lines, and per-season league totals used for the OPE+ baseline.
- **Fetch it yourself** — [`scripts/fetch_pe_data.py`](https://github.com/lch99310/Outs-Per-Effort/blob/main/scripts/fetch_pe_data.py) (`python3 fetch_pe_data.py 2026`), [`scripts/fetch_legends.py`](https://github.com/lch99310/Outs-Per-Effort/blob/main/scripts/fetch_legends.py), and [`scripts/fetch_history.py`](https://github.com/lch99310/Outs-Per-Effort/blob/main/scripts/fetch_history.py). Standard library only, no dependencies.
- **Recompute & re-plot** — [`scripts/analyze_pe.py`](https://github.com/lch99310/Outs-Per-Effort/blob/main/scripts/analyze_pe.py) and [`scripts/make_charts.py`](https://github.com/lch99310/Outs-Per-Effort/blob/main/scripts/make_charts.py) (pandas + matplotlib).

Sample: pitcher-seasons with IP ≥ 50 (≈1,000 across 2023–2025). `outs` and `TB` come straight from the API; FIP uses a per-season constant so league FIP equals league ERA; **OPE+** indexes each season to that year's league-wide OPE. The original 2022 prototype of this idea is preserved in [`archive/`](https://github.com/lch99310/Outs-Per-Effort/tree/main/archive).
