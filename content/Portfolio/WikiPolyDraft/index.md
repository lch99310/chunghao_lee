...
### What AI changes for the editor // AI 為編輯者改變了什麼
...
在 AI 時代，技術已經不是瓶頸了。過去那些卡住一個人不去動手貢獻的瑣事——第一稿翻譯、引用對應、章節結構、語感拿捏——現在 AI 都可以在幾秒內處理完。剩下交還給人的，是這件事一開始就需要人來做的部分：判斷哪些來源可信、核對在不同語言版本之間對不上的事實、規劃一個外國讀者需要哪些背景脈絡、守住編輯的口吻與紀律。

> **AI doesn't replace the editor. It frees the editor.**
>
> **AI 不是要取代編輯者，它是要把編輯者從瑣事中釋放出來。**
...
### A more transparent global record // 一份更透明的全球紀錄
...
程式碼放在 GitHub 上。如果這些話有打到你，一起來蓋吧。
...
- 巴蘭加魯（新南威爾斯州）中文維基百科：[zh.wikipedia.org/wiki/巴蘭加魯_(新南威爾斯州)](https://zh.wikipedia.org/wiki/%E5%B7%B4%E8%98%AD%E5%8A%A0%E9%AD%AF_%28%E6%96%B0%E5%8D%97%E5%A8%81%E7%88%BE%E6%96%AF%E5%B7%9E%29)
