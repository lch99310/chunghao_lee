...
I started on factory floors and grew into AI systems. At **Pegatron Suzhou**, I ran a 15-person team operating an AIoT manufacturing line producing 2M units per year. At **Wistron Taipei** — a global Tier-1 server ODM (Dell, HPE) — I delivered **$1.2M in annual cost savings** through AI-driven predictive maintenance across **40B+ sensor records**, and deployed GPT-4 for log analysis at scale. Now at **TikTok Sydney**, I operate **35 AI moderation models serving 1B+ users and 12M+ weekly content**, and built the **RCA Copilot** human-AI collaboration platform from 0 to 1.
